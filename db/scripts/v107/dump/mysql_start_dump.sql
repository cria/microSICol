...
INSERT INTO `sicol_v107`.`doc_qualifier` (`id_qualifier`,`qualifier`) VALUES 
 (1,'Foto'),
 (2,'Seq'),
 (3,'Doc'),
 (4,'Meio'),
...
INSERT INTO `sicol_v107`.`lang` (`id_lang`,`code`,`lang`,`lang_en`) VALUES 
...
INSERT INTO `sicol_v107`.`loc_country` (`id_country`,`code`) VALUES 
 (1,'AR'),
 (2,'AZ'),
 (3,'BO'),
 (4,'BR'),
...
INSERT INTO `sicol_v107`.`loc_country_lang` (`id_country`,`id_lang`,`country`) VALUES 
 (1,1,'Argentina'),
 (1,2,'Argentina'),
 (2,1,'Azerbaijian'),
 (2,2,'Azerbaijão'),
...
INSERT INTO `sicol_v107`.`loc_state` (`id_state`,`id_country`,`code`,`state`) VALUES 
 (1,4,'AC','Acre'),
 (2,4,'AL','Alagoas'),
 (3,4,'AP','Amapá'),
 (4,4,'AM','Amazonas'),
...
INSERT INTO `sicol_v107`.`taxon_group` (`id_taxon_group`) VALUES
 (1),
 (2),
 (3),
 (4),
...
INSERT INTO `sicol_v107`.`taxon_group_subcoll` (`id_taxon_group`,`id_subcoll`) VALUES
 (1,1),
 (2,1),
 (3,1),
 (4,1),
...
INSERT INTO `sicol_v107`.`taxon_group_lang` (`id_taxon_group`,`id_lang`,`taxon_group`) VALUES
 (1,1,'Bacteria'),
 (1,2,'Bactéria'),
 (2,1,'Fungi'),
 (2,2,'Fungo'),
...
INSERT INTO `sicol_v107`.`spe_subdiv` (`id_subdiv`,`subdiv`) VALUES 
 (0,''),
 (1,'var.'),
 (2,'subsp.'),
 (3,'pv.'),
...
INSERT INTO `sicol_v107`.`str_clinical_form` (`id_clinical_form`) VALUES 
 (1),
 (2),
 (3),
 (4),
...
INSERT INTO `sicol_v107`.`str_clinical_form_lang` (`id_clinical_form`,`id_lang`,`code`,`clinical_form`) VALUES 
...
INSERT INTO `sicol_v107`.`str_dep_reason` (`id_dep_reason`) VALUES 
 (1),
 (2),
 (3);
...
INSERT INTO `sicol_v107`.`str_dep_reason_subcoll` (`id_dep_reason`,`id_subcoll`) VALUES 
 (1,1),
 (2,1),
 (3,1);
...
INSERT INTO `sicol_v107`.`str_dep_reason_lang` (`id_dep_reason`,`id_lang`,`dep_reason`) VALUES 
 (1,1,'Open'),
 (1,2,'Aberto'),
 (2,1,'Closed'),
 (2,2,'Fechado'),
...
INSERT INTO `sicol_v107`.`str_type` (`id_type`) VALUES 
 (1),
 (2),
 (3);
...
INSERT INTO `sicol_v107`.`str_type_subcoll` (`id_type`,`id_subcoll`) VALUES 
 (1,1),
 (2,1),
 (3,1);
...
INSERT INTO `sicol_v107`.`str_type_lang` (`id_type`,`id_lang`,`type`) VALUES 
 (1,1,'Reference'),
 (1,2,'Referência'),
 (2,1,'Type'),
 (2,2,'Tipo'),
...
INSERT INTO `sicol_v107`.`preservation_method` (`id_preservation_method`) VALUES 
 (1),
 (2),
 (3),
 (4),
...
INSERT INTO `sicol_v107`.`preservation_method_subcoll` (`id_preservation_method`,`id_subcoll`) VALUES 
 (1,1),
 (2,1),
 (3,1),
 (4,1),
...
INSERT INTO `sicol_v107`.`preservation_method_lang` (`id_preservation_method`,`id_lang`,`method`,`unit_measure`) VALUES 
...
INSERT INTO `sicol_v107`.`test_group` (`id_test_group`) VALUES 
 (1),
 (2);
/*!40000 ALTER TABLE `test_group` ENABLE KEYS */;

/*!40000 ALTER TABLE `test_group_subcoll` DISABLE KEYS */;
INSERT INTO `sicol_v107`.`test_group_subcoll` (`id_test_group`,`id_subcoll`) VALUES 
 (1,1),
 (2,1);
/*!40000 ALTER TABLE `test_group_subcoll` ENABLE KEYS */;

/*!40000 ALTER TABLE `test_group_lang` DISABLE KEYS */;
INSERT INTO `sicol_v107`.`test_group_lang` (`id_test_group`,`id_lang`,`category`) VALUES 
...
INSERT INTO `sicol_v107`.`str_gps_datum` (`id_gps_datum`,`gps_datum`) VALUES 
 (1,'WGS84'),
 (2,'SAD69'),
 (3,'SIRGAS'),
 (4,'ITRFyy'),
