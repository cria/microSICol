...
INSERT INTO `sicol_v106`.`contact_relations` (`id_person`,`id_institution`,`contact`,`department`,`email`,`last_update`) VALUES 
...
INSERT INTO `sicol_v106`.`institution` (`id_institution`,`code1`,`code2`,`code3`,`complement`,`nickname`,`name`,`address`,`phone`,`email`,`website`,`last_update`) VALUES 
...
INSERT INTO `sicol_v106`.`person` (`id_person`,`name`,`nickname`,`address`,`phone`,`email`,`last_update`) VALUES 
...
INSERT INTO `sicol_v106`.`ref` (`id_ref`,`id_coll`,`id_subcoll`,`title`,`author`,`year`,`url`,`last_update`) VALUES
...
INSERT INTO `sicol_v106`.`species` (`id_species`,`id_coll`,`id_subcoll`,`id_taxon_group`,`genus`,`subgenus`,`species`,`author`,`id_subdiv`,`infra_name`,`infra_author`,`id_name_qualifier`,`taxon_ref`,`synonym`,`hazard_group`,`hazard_group_ref`,`id_alt_states`,`alt_states_type`,`comments`,`last_update`) VALUES 
...
INSERT INTO `sicol_v106`.`strain` (`id_strain`,`id_coll`,`id_subcoll`,`code`,`id_species`,`infra_complement`,`id_type`,`history`,`extra_codes`,`comments`,`last_update`,`status`) VALUES 
