...
INSERT INTO `sicol_v100`.`doc_qualifier` (`id_qualifier`,`qualifier`) VALUES 
 (1,'Foto'),
 (2,'Seq'),
 (3,'Doc'),
 (4,'Meio');
...
INSERT INTO `sicol_v100`.`lang` (`id_lang`,`code`,`lang`,`lang_en`) VALUES 
...
INSERT INTO `sicol_v100`.`loc_country` (`id_country`,`code`) VALUES 
 (1,'AR'),
 (2,'AZ'),
 (3,'BO'),
 (4,'BR'),
...
INSERT INTO `sicol_v100`.`loc_country_lang` (`id_country`,`id_lang`,`country`) VALUES 
 (1,1,'Argentina'),
 (1,2,'Argentina'),
 (2,1,'Azerbaijian'),
 (2,2,'Azerbaijão'),
...
INSERT INTO `sicol_v100`.`spe_subdiv` (`id_subdiv`,`subdiv`) VALUES 
 (1,'var.'),
 (2,'subsp.'),
 (3,'pv'),
 (4,'f.'),
...
INSERT INTO `sicol_v100`.`str_clinical_form` (`id_clinical_form`) VALUES 
 (1),
 (2),
 (3),
 (4),
...
INSERT INTO `sicol_v100`.`str_clinical_form_lang` (`id_clinical_form`,`id_lang`,`code`,`clinical_form`) VALUES 
...
INSERT INTO `sicol_v100`.`str_dep_reason` (`id_dep_reason`) VALUES 
 (1),
 (2),
 (3),
 (4),
...
INSERT INTO `sicol_v100`.`str_dep_reason_lang` (`id_dep_reason`,`id_lang`,`dep_reason`) VALUES 
 (1,1,'Open'),
 (1,2,'Aberto'),
 (2,1,'Closed'),
 (2,2,'Fechado'),
...
INSERT INTO `sicol_v100`.`str_gps_datum` (`id_gps_datum`,`gps_datum`) VALUES 
 (1,'WGS84'),
 (2,'SAD69'),
 (3,'SIRGAS'),
 (4,'ITRFyy'),
...
INSERT INTO `sicol_v100`.`str_type` (`id_type`) VALUES 
 (1),
 (2),
 (3);
...
INSERT INTO `sicol_v100`.`str_type_lang` (`id_type`,`id_lang`,`type`) VALUES 
 (1,1,'Reference'),
 (1,2,'Referência'),
 (2,1,'Type'),
 (2,2,'Tipo'),
...
INSERT INTO roles(id_role,name,type) VALUES (1,'all','all'),(2,'Administrator','level'),(3,'Usuario Padrao do Sistema','user');
/*!40000 ALTER TABLE `roles` ENABLE KEYS */;

-- The Standard User belongs to ALL and Administrator roles
/*!40000 ALTER TABLE `roles_users` DISABLE KEYS */;
INSERT INTO roles_users(id_user,id_role) VALUES (1,1),(1,2),(1,3);
