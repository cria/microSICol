...
INSERT INTO `sicol_v105`.`contact_relations` (`id_person`,`id_institution`,`contact`,`department`,`email`,`last_update`) VALUES 
...
INSERT INTO `sicol_v105`.`institution` (`id_institution`,`code1`,`code2`,`code3`,`complement`,`nickname`,`name`,`address`,`phone`,`email`,`website`,`last_update`) VALUES 
...
INSERT INTO `sicol_v105`.`person` (`id_person`,`name`,`nickname`,`address`,`phone`,`email`,`last_update`) VALUES 
...
INSERT INTO `sicol_v105`.`ref` (`id_ref`,`id_coll`,`id_subcoll`,`author`,`year`,`url`,`last_update`) VALUES
...
INSERT INTO `sicol_v105`.`ref_title` (`id_lang`,`id_coll`,`id_ref`,`title`) VALUES
(2,1,1,'Título Um'),
(1,1,1,'Title One'),
(2,1,2,'...'),
(1,1,2,'...'),
...
INSERT INTO `sicol_v105`.`species` (`id_species`,`id_coll`,`id_subcoll`,`taxon_group`,`genus`,`subgenus`,`species`,`author`,`id_subdiv`,`infra_name`,`infra_author`,`id_name_qualifier`,`taxon_ref`,`synonym`,`hazard_group`,`hazard_group_ref`,`id_alt_states`,`alt_states_type`,`comments`,`last_update`) VALUES 
 ...
 (2,1,1,'bacteria','Leishmania','Leishmania','minor',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
 (3,1,1,'bacteria','Leishmania','Leishmania','ordinaris',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `sicol_v105`.`strain` (`id_strain`,`id_coll`,`id_subcoll`,`code`,`id_species`,`infra_complement`,`id_type`,`history`,`extra_codes`,`comments`,`last_update`,`status`) VALUES 
