...
--
-- table scientific_names_hierarchy
--

LOCK TABLES `scientific_names_hierarchy` WRITE;
/*!40000 ALTER TABLE `scientific_names_hierarchy` DISABLE KEYS */;
DELETE FROM `scientific_names_hierarchy`;
