...
INSERT INTO `sicol_v103`.`ref` (`id_ref`,`id_coll`,`id_subcoll`,`author`,`year`,`url`,`last_update`) VALUES
...
INSERT INTO `sicol_v103`.`ref_title` (`id_lang`,`id_coll`,`id_ref`,`title`) VALUES
(2,1,1,'Título Um'),
(1,1,1,'Title One'),
(2,1,2,'...'),
(1,1,2,'...'),
