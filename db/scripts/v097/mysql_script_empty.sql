CREATE DATABASE IF NOT EXISTS sicol_v0971 CHARACTER SET utf8;
USE sicol_v0971; 
...
CREATE TABLE doc_title (
  ...
  PRIMARY KEY(id_lang, id_coll, id_doc),
...
CREATE TABLE species (
  ...
  INDEX species_fullname(genus, subgenus, species, id_subdiv, infra_name),
  INDEX species_FKIndex1(id_subdiv),
  INDEX species_FKIndex2(id_name_qualifier),
