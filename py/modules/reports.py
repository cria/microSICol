...
class Reports(object):
    ...
    def show(self):
        ...
        #brk(host="localhost", port=9000)
        dict_final = eval(self.form['xml_dict'].value) 
    ...
    def fill_data_step3(self):
        ...
        data['arrayConditions'] = [self.ConvertStrUnicode(_("Equals")).encode("utf8"),self.ConvertStrUnicode(_("Differs")).encode("utf8"), self.ConvertStrUnicode(_("Contains")).encode("utf8"),self.ConvertStrUnicode(_("In")).encode("utf8"),
                                   self.ConvertStrUnicode(_("Not in")).encode("utf8"),self.ConvertStrUnicode(_("Greater")).encode("utf8"),self.ConvertStrUnicode(_("Greater or equal")).encode("utf8"),
                                   self.ConvertStrUnicode(_("Less")).encode("utf8"),self.ConvertStrUnicode(_("Less or equal")).encode("utf8")]
       
        data['arrayConnectors'] = ['AND','OR']
        
        data['arrayTypes'].append(self.ConvertStrUnicode(_('Fixed')).encode("utf8"))
        data['arrayTypes'].append(self.ConvertStrUnicode(_('Variable')).encode("utf8"))
        data['arrayTypes'].append(self.ConvertStrUnicode(_('Field')).encode("utf8"))
